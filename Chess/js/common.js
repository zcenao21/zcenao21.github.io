...
window.onload = function(){  
	...
	// 提示
	com.get("hintBtn").addEventListener("click", function(e) {
		play.hint();
	})

	// 反转棋盘
	com.get("revBtn").addEventListener("click", function(e) {
		play.revert();
	})

	//当前谁走棋
	com.get("redRadio").addEventListener("click", function(e) {
		play.my = 1 ;
	})

	//当前谁走棋
	com.get("blackRadio").addEventListener("click", function(e) {
		play.my = -1 ;
	})
